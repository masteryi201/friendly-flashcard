...
def display_frames_after (can, onyomi1, kunyomi1, remember1, Han_Viet1,  meaning1_1, meaning1_2, meaning1_3, meaning1_4, onyomi5, kunyomi5, remember5, Han_Viet5, meaning5_1, meaning5_2, meaning5_3, meaning5_4, count_row) :
	...
	can.drawCentredString(448, count_row*210.5 + 170,Han_Viet1)
	can.setFont('simsun', 14, leading=None)
	can.drawString(323, count_row*210.5 + 150,"★訓 :" + onyomi1)
	can.setFont('simsun', 14, leading=None)
	can.drawString(323, count_row*210.5 + 130,"★音 :" + kunyomi1)
	can.setFont('times-new-roman', 12, leading=None)
	can.drawString(323, count_row*210.5 + 110,remember1)
	can.setFont('simsun', 14, leading=None)
	if meaning1_1 != "_" :
	...
	can.setFont('times-new-roman', 20, leading=None)
	can.drawCentredString(150, count_row*210.5 + 170,Han_Viet5)
	can.setFont('simsun', 14, leading=None)
	can.drawString(25, count_row*210.5 + 150,"★訓 :" + onyomi5)
	can.setFont('simsun', 14, leading=None)
	can.drawString(25, count_row*210.5 + 130,"★音 :" + kunyomi5)
	can.setFont('times-new-roman', 12, leading=None)
	can.drawString(25, count_row*210.5 + 110,remember5)
	can.setFont('simsun', 14, leading=None)
	if meaning5_1 != "_" :
